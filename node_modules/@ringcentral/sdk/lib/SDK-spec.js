...
describe('RingCentral.SDK', function () {
    it('connects to production', function theTest() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        server = test_1.SDK.server.production;
                        sdk = new test_1.SDK({
                            server: server,
                            clientId: '',
                            clientSecret: '',
                    ...
                    case 2:
                        _a.sent();
                        (0, test_1.expect)(res.status).toEqual(200);
                        return [2 /*return*/];
                }
            });
        });
    ...
    it('sets rate limit', function rateLimitTest() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                (0, test_1.expect)(sdk.platform()['_handleRateLimit']).toEqual(60);
                return [2 /*return*/];
            });
        });
    });
    describe('handleLoginRedirect', function () {
        ...
        it('handles hash', function () {
            ...
            (0, test_1.expect)(s.mock.calls[0][0]).toEqual({ RCAuthorizationResponse: '#foo' });
            (0, test_1.expect)(s.mock.calls[0][1]).toEqual('foo');
        });
