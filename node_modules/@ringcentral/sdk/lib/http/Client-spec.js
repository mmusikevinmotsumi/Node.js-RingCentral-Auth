...
describe('RingCentral.http.Client', function () {
    describe('createRequest', function () {
        it('sets default headers & properties for GET', (0, test_1.asyncTest)(function (sdk) {
            ...
            (0, test_1.expect)(request.headers.get('Content-Type')).toEqual('application/json');
            (0, test_1.expect)(request.url).toEqual('http://foo/bar?foo=foo');
            (0, test_1.expect)(request.method).toEqual('GET');
        }));
        it('sets default headers & properties for POST', (0, test_1.asyncTest)(function (sdk) {
            ...
            (0, test_1.expect)(request.headers.get('Content-Type')).toEqual('application/json');
            (0, test_1.expect)(request.url).toEqual('http://foo/bar');
            (0, test_1.expect)(request.method).toEqual('POST');
            (0, test_1.expect)(request['originalBody']).toEqual(JSON.stringify({ foo: 'bar' }));
        }));
        ...
        it('parses OK headers into object', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        (0, test_1.expect)(sdk.client().isJson(res)).toEqual(true);
                        return [2 /*return*/];
                }
            });
        }); }));
        it('parses Multi-Status headers into object', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        (0, test_1.expect)(sdk.client().isMultipart(res)).toEqual(true);
                        return [2 /*return*/];
                }
            });
        }); }));
        ...
        it('calls the success callback for all individual parts that are parsed (including errors)', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        multipart = _c.sent();
                        (0, test_1.expect)(multipart.length).toEqual(3);
                        _a = test_1.expect;
                        return [4 /*yield*/, multipart[0].json()];
                    case 3:
                        _a.apply(void 0, [(_c.sent()).foo]).toEqual('bar');
                        (0, test_1.expect)(multipart[0].status).toEqual(200);
                        (0, test_1.expect)(sdk.client().error(multipart[1])).not.toEqual(null); //FIXME
                        _b = test_1.expect;
                        return [4 /*yield*/, multipart[2].json()];
                    case 4:
                        _b.apply(void 0, [(_c.sent()).baz]).toEqual('qux');
                        (0, test_1.expect)(multipart[2].status).toEqual(200);
                        return [2 /*return*/];
                }
            });
        }); }));
