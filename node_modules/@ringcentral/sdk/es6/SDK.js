...
export { Cache, Externals, };
var defaultExternals = {};
export var setDefaultExternals = function (externals) { return (defaultExternals = externals); };
var SDK = /** @class */ (function () {
    function SDK(options) {
        ...
        if ((options === null || options === void 0 ? void 0 : options.server) === SDK.server.sandbox) {
            // eslint-disable-next-line no-console
            console.warn('Sandbox support is deprecated. Please migrate your application to Production Server.');
        }
        this._externals = new Externals(__assign(__assign({}, defaultExternals), options));
        ...
        this._platform = new Platform(__assign(__assign({}, options), { externals: this._externals, client: this._client, cache: this._cache, handleRateLimit: handleRateLimit }));
    }
