...
var Cache = /** @class */ (function () {
    ...
    Cache.prototype.setItem = function (key, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._externals.localStorage.setItem(this._prefixKey(key), JSON.stringify(data))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Cache.prototype.removeItem = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._externals.localStorage.removeItem(this._prefixKey(key))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Cache.prototype.getItem = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._externals.localStorage.getItem(this._prefixKey(key))];
                    case 1:
                        item = _a.sent();
                        if (!item) {
