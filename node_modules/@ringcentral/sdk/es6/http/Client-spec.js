...
describe('RingCentral.http.Client', function () {
    ...
    describe('constructor tests', function () {
        it('parses OK headers into object', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            var res;
        ...
        it('parses Multi-Status headers into object', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe('multipart', function () {
        it('calls the success callback after parsing a good multi-part/mixed response', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('calls the success callback for all individual parts that are parsed (including errors)', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        _a.apply(void 0, [(_c.sent()).foo]).toEqual('bar');
                    ...
                    case 4:
                        _b.apply(void 0, [(_c.sent()).baz]).toEqual('qux');
                        expect(multipart[2].status).toEqual(200);
                        return [2 /*return*/];
                }
            });
        }); }));
        it('calls the error callback if it fails to parse the parts info block', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('calls the error callback if it is unable to parse the JSON data, passing the error object', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('uses the error_description property of the JSON data when there is an error but no message property', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, expectThrows(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
        ...
        it('uses the description property of the JSON data when there is an error but no message or error_description properties', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, expectThrows(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
        ...
        it('throws an error when no body', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, expectThrows(function () { return __awaiter(void 0, void 0, void 0, function () {
                            var res;
        ...
        it('throws an error when not multipart', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, expectThrows(function () { return __awaiter(void 0, void 0, void 0, function () {
                            var res;
        ...
        it('throws an error when no boundary', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, expectThrows(function () { return __awaiter(void 0, void 0, void 0, function () {
                            var res;
    ...
    describe('toMultipart', function () {
        it('returns an array with self if not multipart', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            var res, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a.apply(void 0, [(_b.sent())[0]]).toEqual(res);
                        return [2 /*return*/];
                }
            });
        }); }));
