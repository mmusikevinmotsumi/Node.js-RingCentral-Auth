...
import { apiCall, asyncTest, authentication, cleanFetchMock, createSdk, expect, expectThrows, getExternalDiscoveryMockData, getInitialDiscoveryMockData, logout, spy, tokenRefresh, } from '../test/test';
...
describe('RingCentral.platform.Platform', function () {
        ...
        it('is added with default value', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        expect(request.headers.get('x-user-agent')).toEqual("RCJSSDK/".concat(version));
                        expect(platform.userAgent).toEqual("RCJSSDK/".concat(version));
                        return [2 /*return*/];
                }
            });
        }); }));
    ...
    describe('login', function () {
        ...
        it('login with username/password without extension', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            var platform, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        expect(platform.createUrl('/restapi/v1.0/foo', { addServer: true })).toEqual('http://whatever/restapi/v1.0/foo');
                        _a = expect;
    ...
    describe('loginUrl', function () {
        it('simple usage', asyncTest(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                })).toEqual('http://whatever/restapi/oauth/authorize?response_type=code&redirect_uri=http%3A%2F%2Ffoo&client_id=whatever&state=&brand_id=&display=&prompt=&ui_options=foo&ui_options=bar&ui_locales=&localeId=&response_hint=baz&response_hint=quux&login_hint=rc%40xyz.com&login_hint=rc1%40xyz.com');
                /**
                 * Test with loginHin parameter in loginUrl method
                 */
                expect(platform.loginUrl({
                ...
                })).toEqual('http://whatever/restapi/oauth/authorize?response_type=code&redirect_uri=http%3A%2F%2Ffoo&client_id=whatever&state=&brand_id=&display=&prompt=&ui_options=foo&ui_locales=&localeId=&response_hint=bar&login_hint=rc%40xyz.com');
                return [2 /*return*/];
            });
        }); }));
    });
    ...
    describe('Auth setData', function () {
        it('should set auth data successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        sdk = createSdk({ clientId: 'xxx', clientSecret: 'yyy', server: '' });
                        platform = sdk.platform();
                        oldToken = {
                            access_token: 'xxx',
                            refresh_token: 'yyy',
